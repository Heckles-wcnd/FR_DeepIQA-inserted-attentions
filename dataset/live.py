import sys
sys.path.append("C:/Users/zbb/Desktop/FR_DEEPIQA-master/FR_DEEPIQA-master/dataset/live.py")
...
BASE_PATH = 'C:/Users/zbb/Desktop/GraduateProject/DeepQA-with-Pytorch-master/DeepQA-with-Pytorch-master/data/LIVE_dataset/'
LIST_FILE_NAME = 'C:/Users/zbb/Desktop/FR_DEEPIQA-master/FR_DEEPIQA-master/LIVE_IQA.txt'
TRAIN_RATIO=0.8
ALL_SCENES = list(range(29))  # 24
ALL_DIST_TYPES = list(range(5))  # 24
...
def get_dataset():
    """
           Make train and test image list from LIVE database
           LIVE: 29 reference images x 24 distortions
           """
    ...
    for index in range(n_images):
        ...
        # elif scenes[index] in test_scenes_indexs \
        #         and dist_types[index] == 2:
        #     """
        #     dist_types = [0] for jpk2
        #                  [1] for jpeg
        #                  [2] for wn
        #                  [3] for gblur
        #                  [4] for fastfading
    ...
    train_score_list = 1.0 - train_score_list
    test_score_list = 1.0 - test_score_list
...
class LIVE_dataset(Dataset):
    ...
    def load_distored_img(self,patch_info,ref_top_left_set,img_relative_path):
        ...
        d_img_raw =  imageio.v2.imread( img_path)
...
if __name__ == '__main__':
    ...
    dataset=LIVE_dataset("C:/Users/zbb/Desktop/GraduateProject/DeepQA-with-Pytorch-master/DeepQA-with-Pytorch-master/data/LIVE_dataset/",None)
